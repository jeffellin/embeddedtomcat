...
MAIN_CLASS=org.demo.example.RunTom
...
# Split up the JVM_OPTS And JETTY_GRADLE_OPTS values into an array, following the shell quoting and substitution rules
function splitJvmOpts() {
    JVM_OPTS=("$@")
}
eval splitJvmOpts $DEFAULT_JVM_OPTS $JAVA_OPTS $JETTY_GRADLE_OPTS
